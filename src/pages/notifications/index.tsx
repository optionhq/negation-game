...
function FollowNotification({ notification }: { notification: Notification }) {
...
function ReplyNotification({ notification }: { notification: Notification }) {
...
function MentionNotification({ notification }: { notification: Notification }) {
	return (
		<div>
...
function LikeNotification({ notification }: { notification: Notification }) {
	const [node, setNode] = useState<Node>();
	const [isLinkingPoint, setIsLinkingPoint] = useState<boolean>(false);
